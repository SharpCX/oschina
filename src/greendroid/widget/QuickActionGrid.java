			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null) {
					...
					final LayoutInflater inflater = LayoutInflater
							.from(getContext());
					convertView = inflater.inflate(R.layout.gd_quick_action_grid_item, null);
					viewHolder.tv = (TextView) convertView.findViewById(R.id.grid_item_tv);
				...
				viewHolder.tv.setText(quickAction.getTitle());
				viewHolder.tv.setCompoundDrawablesWithIntrinsicBounds(null,
						quickAction.getIcon(), null, null);
